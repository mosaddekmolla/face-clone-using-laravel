        ...
        <form action="{{route('profile.edit')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="text-center" onmouseover="showUploadButton();" onmouseout="hideUploadButton();">
                <div class="form-group button-image">
                    <img class="img-circle" src="{{asset(auth()->user()->image ?? '/images/default_image.jpg')}}">
                ...
                <div class="form-group">
                    <button type="submit" class="image-upload btn btn-success" style="display: none;">Save</button>
                </div>
            </div>
        </form>
