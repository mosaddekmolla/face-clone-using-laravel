                        ...
                        <div class=" col-sm-6">
                            <div class="signup-form">
                                ...
                                <form action="{{route('saveRegister')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="password" placeholder="Retype Password" name="password_confirmation" class="input-lg col-sm-12"/>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="input-lg" name="date" value="{{old('date')}}">
                                            ...
                                            <div class="col-sm-3">
                                                <select class="input-lg" name="month" value="{{old('month')}}"><option value="0" selected="selected">Month</option><option value="1">Jan</option><option value="2">Feb</option><option value="3">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6">Jun</option><option value="7">Jul</option><option value="8">Aug</option><option value="9">Sept</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option></select>
                                                @error('month')
                                                    <div class="alert alert-danger">
                                                        {{$message}}
                                                    </div>
